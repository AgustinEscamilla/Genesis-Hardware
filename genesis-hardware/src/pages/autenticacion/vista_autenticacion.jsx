...
export function VistaAutenticacion() {
  ...
  if (cargando) return <div className="min-h-screen bg-fondo flex items-center justify-center text-texto">Cargando acceso</div>

  return <div className="min-h-screen bg-fondo px-4 py-10 text-texto"><div className="mx-auto relative w-full max-w-md overflow-hidden border border-borde bg-panel/95 p-8 shadow-2xl shadow-primario/10"><div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primario to-transparent"></div><div className="mb-8 space-y-2"><p className="text-xs uppercase tracking-[0.4em] text-primario">Genesis Hardware</p></div><FormularioAcceso /><div className="mt-6 border-t border-borde pt-4"><BotonGoogleCliente /></div></div></div>
}