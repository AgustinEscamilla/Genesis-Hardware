...
export function VistaRecepcionDistribuidorEmpleado() {
  return <section className="mx-auto flex w-full max-w-6xl flex-col gap-6">
    ...
    <article><div className="mb-3 flex items-end justify-between gap-4"><div><p className="text-[10px] font-bold uppercase tracking-widest text-primario">Seguimiento</p><h2 className="mt-2 text-xl font-black text-texto">Mercancía del distribuidor</h2></div><span className="text-xs text-mutado">Actualización automática pendiente</span></div><TablaOperacionesDistribuidor operaciones={[]} mensaje_vacio="No hay mercancía pendiente de recepción" /></article>
  </section>
}
